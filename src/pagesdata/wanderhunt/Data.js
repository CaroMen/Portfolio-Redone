export const wanderhunt = {
    ...
    lessons1: 'The most intricate part of this project was working in a group of 4 and managing what we would each work on. While having the freedom to make this decision for ourselves, it was also challenging making sure we each had equal opportunity to work on the frontend and backend. This was a big opportunity to work with people completely different from myself, participate in stand ups, gain more experience with version control, and push myself to build a user friendly working application in a 10 day sprint.'
    // title2: 'SpireCamp',
